...
import { getUserData } from '../services/user_info.js';
...
const StartForm = ({name, email, phone, cpf, setName, setPhone, setCpf, errors, paymentMethod, setPaymentMethod, value, handleSubmit}) => {
  return (
    <div className="auth-container">
    <div className='contact_form'>
    <DescricaoInicialSite />
...
const PixForm = ({isMobile, name, email, value, pix_code, customer_id, setStep}) => {
  ...
  return (
    ...
    <p align="center">Faça o Pix no valor de <b>R$ {value.toFixed(2)}</b> para 1 ano de plano premium no site Domínio Elétrico.</p>
    ...
    <PixLoadingMessage />
    <p align="center">
    Os cursos premium são liberados logo após o pagamento.
    </p>
...
const EndForm = ({payStatus, name, email, password}) => {
  ...
  return (
    <div className="auth-container">
    <div className='contact_form'>
      <h3 align="center">Parabéns pela assinatura do plano premium do site!</h3>
