...
keywords: ['Eletrônico', 'Capacitor', 'Diodo', 'Ativo', 'Transformador', 'Componente', 'Resistente']
---
...
Por outro lado, componentes ativos são capazes de controlar o fluxo de corrente elétrica e podem amplificar sinais elétricos. Eles necessitam de uma fonte de energia externa para funcionar. Exemplos de componentes ativos incluem transistores, diodos e circuitos integrados. Um transistor, por exemplo, pode amplificar um sinal elétrico, tornando-o essencial em amplificadores e outros dispositivos eletrônicos.
