...
keywords: ['Tensão', 'Indutor', 'Passivo', 'Componente', 'Diodo', 'Eletrônico', 'Capacitor']
---
...
Por outro lado, componentes ativos são capazes de controlar o fluxo de corrente elétrica e podem amplificar sinais elétricos. Eles necessitam de uma fonte de energia externa para funcionar. Exemplos de componentes ativos incluem transistores, diodos e circuitos integrados. Um transistor, por exemplo, pode amplificar um sinal elétrico, enquanto um diodo permite que a corrente flua em apenas uma direção, funcionando como uma espécie de válvula.
