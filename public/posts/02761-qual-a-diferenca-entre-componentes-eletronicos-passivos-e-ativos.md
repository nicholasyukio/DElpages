...
keywords: ['Tensão', 'Eletrônico', 'Transformador', 'Diodo', 'Passivo', 'Transistor', 'Ativo']
---
...
Por outro lado, **componentes ativos** são capazes de amplificar sinais elétricos e, em alguns casos, gerar energia. Eles necessitam de uma fonte de energia externa para funcionar. Exemplos de componentes ativos incluem transistores, diodos e circuitos integrados. Os transistores, por exemplo, são amplamente utilizados em amplificadores e osciladores devido à sua capacidade de controlar grandes correntes com pequenas correntes de entrada.
